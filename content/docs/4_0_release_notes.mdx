---
title: Заметки о релизе Ruby on Rails 4.0
description: "Ключевые новинки в Rails 4.0:"
---
...
[![Rails 4.0](/images/4_0_release_notes/rails4_features.png)](4_0_release_notes/rails4_features.png)
...
* Улучшены способы написания миграций `change`, что делает старые методы `up` & `down` больше не нужными.
    ...
    * Новый метод `reversible` делает возможным определить код для исполнения при выполнении или откате миграции.
      Смотрите руководство [Миграции Active Record](/docs/active-record-migrations#using-reversible)
    ...
    * Новый метод `revert` обратит всю миграцию или предоставленный блок.
      ...
      Смотрите руководство [Миграции Active Record](/docs/active-record-migrations#reverting-previous-migrations)
