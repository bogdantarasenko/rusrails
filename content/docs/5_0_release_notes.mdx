---
title: Заметки о релизе Ruby on Rails 5.0
description: "Ключевые новинки в Rails 5.0:"
---
...
Подробности смотрите в руководстве [Обзор Action Cable](/docs/action_cable_overview).
...
Приложение представляет основу для API, которая затем может быть [настроена](/docs/api_app) под нужды приложения.

Подробности смотрите в руководстве [Использование Rails для API-приложений](/docs/api_app).
