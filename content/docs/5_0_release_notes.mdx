...
Подробности смотрите в руководстве [Обзор Action Cable](/docs/action-cable-overview).
...
Приложение представляет основу для API, которая затем может быть [настроена](/docs/api-app) под нужды приложения.

Подробности смотрите в руководстве [Использование Rails для API-приложений](/docs/api-app).
