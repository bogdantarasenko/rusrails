...
Вы также можете указать тип столбца и создание индекса, используя опцию [`:polymorphic`](/docs/active-record-associations#polymorphic-associations):
...
Метод миграции [`create_join_table`][] создает соединительную таблицу [HABTM (has and belongs to many, многие ко многим)](/docs/active-record-associations#the-has-and-belongs-to-many-association). Обычное использование будет таким:
