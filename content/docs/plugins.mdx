---
title: Основы создания плагинов Rails
description: "Плагин Rails - это либо расширение, либо модификация основного фреймворка. Плагины представляют:"
---
...
Генераторы могут быть включены в гем простым добавлением в директорию `lib/generators` плагина. Подробнее о создании генераторов смотрите в руководстве [Создание и настройка генераторов и шаблонов Rails](/docs/generators).
