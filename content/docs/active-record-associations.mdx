...
[foreign_keys]: /docs/active-record-migrations#foreign-keys
...
* Проверяет [наличие](/docs/active-record-validations#presence) и [отсутствие](/docs/active-record-validations#absence) связей в большинстве случаев:
...
Внутри блока скоупа можно использовать любые стандартные [методы запросов](/docs/active-record-querying). Далее обсудим следующие из них:
