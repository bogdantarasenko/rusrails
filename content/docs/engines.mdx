...
Engine, раскрываемый в этом руководстве, предоставляет функциональность отправки статей и комментирования, и излагается подобно в руководстве [Rails для начинающих](/docs/getting_started), с некоторыми новыми особенностями.
...
Обратитесь к руководству [Автозагрузка и перезагрузка констант](/docs/autoloading_and_reloading_constants#autoloading-and-engines)
...
Более подробно читайте в руководстве [Asset Pipeline](/docs/asset_pipeline).
