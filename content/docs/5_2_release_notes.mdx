---
title: Заметки о релизе Ruby on Rails 5.2
description: "Ключевые новинки в Rails 5.2:"
---
...
Rails 5.2 поставляется со встроенным хранилищем кэша Redis. Подробнее об этом можно прочитать в руководстве [Кэширование с Rails: Обзор](/docs/caching-with-rails#activesupport-cache-rediscachestore).
...
Подробнее об этом можно узнать в руководстве [Безопасность приложений на Rails](/docs/security#custom-credentials).
...
Подробнее об этом можно узнать в руководстве руководстве [Безопасность приложений на Rails](/docs/security#content-security-policy).
