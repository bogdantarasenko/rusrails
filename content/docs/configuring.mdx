...
Пожалуйста, за подробностями обратитесь к [руководству по автозагрузке](/docs/autoloading-and-reloading-constants).
...
Определяет метод доставки, по умолчанию `:smtp`. За подробностями обращайтесь к разделу по настройке в руководстве [Основы Action Mailer](/docs/action-mailer-basics#action-mailer-configuration)
...
Конфигурационные опции описаны подробнее в [Обзор Action Cable](/docs/action-cable-overview#configuration).
