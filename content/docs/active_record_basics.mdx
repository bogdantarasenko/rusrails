...
* `(association_name)_type` - Хранит тип для [полиморфных связей](/docs/association_basics#polymorphic-associations).
...
Существует множество других методов Active Record для чтения и запроса записей. Подробнее о них вы можете узнать в руководстве [по запросам Active Record](/docs/active_record_querying).
...
Подробнее о валидациях можно прочитать в руководстве [Валидации Active Record](/docs/active_record_validations).
...
Подробнее о колбэках можно прочитать в руководстве [Колбэки Active Record](/docs/active_record_callbacks).
...
Подробнее о миграциях можно прочитать в [руководстве по миграциям Active Record](/docs/active_record_migrations)
...
Подробнее о связях можно прочитать в [руководстве по связям Active Record](/docs/association_basics).
