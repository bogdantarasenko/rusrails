---
title: Заметки о релизе Ruby on Rails 3.1
description: "Ключевые новинки в Rails 3.1:"
---
...
* Снова, большинство изменений относится к конвейеру ресурсов. Подробнее о них можно прочитать в руководстве [Asset Pipeline](/docs/asset_pipeline).
...
Конвейер ресурсов работает с помощью [Sprockets](https://github.com/rails/sprockets) и раскрывается в руководстве [Asset Pipeline](/docs/asset_pipeline).
